...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_NONE, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Sceptile"),
    ...
    [SPECIES_BLAZIKEN_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_NONE, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Blaziken"),
    #if P_MODIFIED_MEGA_CRIES
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GARDEVOIR_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_PIXILATE, ABILITY_NONE, ABILITY_TRACE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Gardevoir"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GALLADE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Gallade"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_AGGRON_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_FILTER, ABILITY_NONE, ABILITY_SCREEN_CLEANER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aggron"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEDICHAM_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PURE_POWER, ABILITY_NONE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Medicham"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MANECTRIC_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_NONE, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Manectric"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CAMERUPT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_NONE, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Camerupt"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ALTARIA_MEGA] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_PIXILATE, ABILITY_NONE, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Altaria"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WIND_RIDER, ABILITY_NONE, ABILITY_SERENE_GRACE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ABSOL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_NONE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Absol"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GLALIE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_REFRIGERATE, ABILITY_NONE, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Glalie"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_FROSLASS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_SNOW_WARNING, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Froslass"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_ALOMOMOLA}),
    },
    ...
    [SPECIES_SALAMENCE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_AERILATE, ABILITY_NONE, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Salamence"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_METAGROSS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Metagross"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DEOXYS_SPEED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Deoxys"),
        .cryId = CRY_DEOXYS,
