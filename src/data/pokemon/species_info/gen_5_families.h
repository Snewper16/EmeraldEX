...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_EMBOAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_NONE, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Emboar"),
    ...
    [SPECIES_EXCADRILL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PIERCING_DRILL, ABILITY_NONE, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Excadrill"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SCOLIPEDE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Scolipede"),
    #if P_MODIFIED_MEGA_CRIES
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_EELEKTROSS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_EELEVATE, ABILITY_NONE, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Eelektross"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CHANDELURE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_INFILTRATOR, ABILITY_NONE, ABILITY_SHADOW_TAG },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Chandelure"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GOLURK_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_UNSEEN_FIST, ABILITY_NONE, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Golurk"),
    #if P_MODIFIED_MEGA_CRIES
