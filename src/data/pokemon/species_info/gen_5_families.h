...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        .abilities = { ABILITY_VICTORY_STAR, ABILITY_NONE, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_TORNADUS_THERIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_REGENERATOR, ABILITY_NONE, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Tornadus"),
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TURBOBLAZE, ABILITY_NONE, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_KELDEO_RESOLUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_NONE, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Keldeo"),
        .cryId = CRY_KELDEO,
