const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_GYM_LEADER_ROXANNE] = TRAINER_PIC_GYM_LEADER_ROXANNE,
    [FACILITY_CLASS_GYM_LEADER_BRAWLY] = TRAINER_PIC_GYM_LEADER_BRAWLY,
    [FACILITY_CLASS_GYM_LEADER_TATE_AND_LIZA] = TRAINER_PIC_GYM_LEADER_TATE_AND_LIZA,
