...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_ROXANNE, gTrainerFrontPic_LeaderRoxanne, gTrainerPalette_LeaderRoxanne),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_BRAWLY, gTrainerFrontPic_LeaderBrawly, gTrainerPalette_LeaderBrawly),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_WATTSON, gTrainerFrontPic_LeaderWattson, gTrainerPalette_LeaderWattson),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_FLANNERY, gTrainerFrontPic_LeaderFlannery, gTrainerPalette_LeaderFlannery),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_NORMAN, gTrainerFrontPic_LeaderNorman, gTrainerPalette_LeaderNorman),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_WINONA, gTrainerFrontPic_LeaderWinona, gTrainerPalette_LeaderWinona),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_TATE_AND_LIZA, gTrainerFrontPic_LeaderTateAndLiza, gTrainerPalette_LeaderTateAndLiza),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_JUAN, gTrainerFrontPic_LeaderJuan, gTrainerPalette_LeaderJuan),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_GIOVANNI_FRLG, gTrainerFrontPic_LeaderGiovanniFrlg, gTrainerPalette_LeaderGiovanniFrlg),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_BROCK_FRLG, gTrainerFrontPic_LeaderBrockFrlg, gTrainerPalette_LeaderBrockFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_MISTY_FRLG, gTrainerFrontPic_LeaderMistyFrlg, gTrainerPalette_LeaderMistyFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_LT_SURGE_FRLG, gTrainerFrontPic_LeaderLtSurgeFrlg, gTrainerPalette_LeaderLtSurgeFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_ERIKA_FRLG, gTrainerFrontPic_LeaderErikaFrlg, gTrainerPalette_LeaderErikaFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_KOGA_FRLG, gTrainerFrontPic_LeaderKogaFrlg, gTrainerPalette_LeaderKogaFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_BLAINE_FRLG, gTrainerFrontPic_LeaderBlaineFrlg, gTrainerPalette_LeaderBlaineFrlg),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GYM_LEADER_SABRINA_FRLG, gTrainerFrontPic_LeaderSabrinaFrlg, gTrainerPalette_LeaderSabrinaFrlg),
