...
// Vitamins
    ...
    [ITEM_PP_MAX] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 10000 : 9500,
        .description = COMPOUND_STRING(
            "Raises the PP of a\n"
            "move to its maximum\n"
            "points."),
...
// Ability Modifiers
    ...
    [ITEM_ABILITY_PATCH] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 250000 : 15000,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Turns the ability\n"
            "of a Pokémon into\n"
...
// Mints
    ...
    [ITEM_LONELY_MINT] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 20000 : 2000,
        .description = COMPOUND_STRING(
            "Can be smelled. It\n"
            "ups Attack, but\n"
            "reduces Defense."),
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_SOLAR_BLADE] =
    {
        ...
        .description = COMPOUND_STRING(
				...
				"absorbs light the first\n"
				"turn, then slashes a blade."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    ...
    [ITEM_TM_TERA_BLAST] =
    {
        ...
        .price = 5000,
        .description = COMPOUND_STRING(
				"Changes type and bases\n"
				"attack category on the\n"
				"stronger offense stat."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
