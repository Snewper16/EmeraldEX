...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[54] =
{
    ...
    {TRAINER_CLASS_AQUA_BOSS, TRAINER_ENCOUNTER_MUSIC_AQUA},
    ...
    {TRAINER_CLASS_MAGMA_BOSS, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {TRAINER_CLASS_GYM_LEADER, TRAINER_ENCOUNTER_MUSIC_INTENSE},
...
static const u16 sShortStreakRewardItems[] = {ITEM_HP_UP, ITEM_PROTEIN, ITEM_IRON, ITEM_CALCIUM, ITEM_CARBOS, ITEM_ZINC, ITEM_PP_UP, ITEM_PP_MAX};
static const u16 sLongStreakRewardItems[] = {ITEM_BRIGHT_POWDER, ITEM_WHITE_HERB, ITEM_QUICK_CLAW, ITEM_FOCUS_SASH, ITEM_CHOICE_SPECS, ITEM_KINGS_ROCK, ITEM_CHOICE_SCARF, ITEM_SCOPE_LENS, ITEM_CHOICE_BAND};
