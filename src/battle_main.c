...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_GYM_LEADER] = { _("GYM LEADER"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 3, BALL_FRIEND },
    ...
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("AROMA LADY"), 7, BALL_FRIEND },
