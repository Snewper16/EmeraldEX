...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("BURGLAR"), 22, BALL_MOON },
    ...
    [TRAINER_CLASS_GAMER_FRLG] =           { _("GAMER"), 18, BALL_GREAT},
    ...
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6, BALL_LEVEL },
    ...
    [TRAINER_CLASS_ROCKET_BOSS_FRLG] =     { _("ROCKET BOSS"), 25, BALL_MASTER },
    [TRAINER_CLASS_GYM_LEADER_FRLG] =      { _("GYM LEADER"), 25, BALL_ULTRA },
