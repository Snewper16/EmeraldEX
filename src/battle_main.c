...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12, BALL_ULTRA },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 1, BALL_LURE },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15, BALL_LUXURY },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 8, BALL_LEVEL },
    ...
    [TRAINER_CLASS_GYM_LEADER] = { _("GYM LEADER"), 25, BALL_ULTRA },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID"), BALL_POKE },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. AND JR."), 4, BALL_GREAT },
    ...
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATHLETE"), 10, BALL_SAFARI },
    ...
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 3, BALL_LOVE },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 8, BALL_DIVE },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 10, BALL_SAFARI },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 15, BALL_POKE },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4, BALL_NET },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12, BALL_FRIEND },
    [TRAINER_CLASS_MAGMA_BOSS] = { _("MAGMA BOSS"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 4, BALL_POKE },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 8, BALL_LOVE},
    [TRAINER_CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 10, BALL_ULTRA },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 3, BALL_DIVE },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("SALON MAIDEN"), 5, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE] = { _("DOME ACE"), 5, BALL_ULTRA },
    [TRAINER_CLASS_PALACE_MAVEN] = { _("PALACE MAVEN"), 5, BALL_ULTRA  },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("ARENA TYCOON"), 5, BALL_ULTRA },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("FACTORY HEAD"), 5, BALL_ULTRA },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("PIKE QUEEN"), 5, BALL_ULTRA },
    [TRAINER_CLASS_PYRAMID_KING] = { _("PYRAMID KING"), 5, BALL_ULTRA },
    [TRAINER_CLASS_RS_PROTAG] = { _("{PKMN} TRAINER"), 5, BALL_ULTRA },

    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { _("YOUNGSTER"), 4, BALL_POKE },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("BUG CATCHER"), 3, BALL_NET },
    [TRAINER_CLASS_LASS_FRLG] =            { _("LASS"), 4, BALL_POKE },
    ...
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéMANIAC"), 12, BALL_LUXURY },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("SUPER NERD"), 6, BALL_LEVEL },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("HIKER"), 9, BALL_HEAVY, },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("BIKER"), 5, BALL_DUSK },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("BURGLAR"), 22, BALL_DUSK },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("ENGINEER"), 12, BALL_FAST },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("FISHERMAN"), 9, BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("SWIMMER♂"), 1, BALL_DIVE },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("CUE BALL"), 6, BALL_DUSK },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("GAMER"), 18, BALL_LUXURY },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("BEAUTY"), 18, BALL_LOVE },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("SWIMMER♀"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("PSYCHIC"), 5, BALL_DUSK },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6, BALL_FAST },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("JUGGLER"), 10, BALL_FRIEND },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("TAMER"), 10, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("BIRD KEEPER"), 6, BALL_SAFARI },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("BLACK BELT"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("RIVAL"), 4, BALL_POKE },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("SCIENTIST"), 12, BALL_LEVEL },
    [TRAINER_CLASS_ROCKET_BOSS_FRLG] =     { _("BOSS"), 25, BALL_MASTER },
    [TRAINER_CLASS_GYM_LEADER_FRLG] =      { _("LEADER"), 25, BALL_ULTRA },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("TEAM ROCKET"), 8, BALL_GREAT },
    ...
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { _("RIVAL"), 9, BALL_POKE },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("CHAMPION"), 25, BALL_POKE },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("CHANNELER"), 8, BALL_DUSK },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("TWINS"), 3, BALL_LOVE },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("COOL COUPLE"), 6, BALL_ULTRA },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("YOUNG COUPLE"), 7, BALL_LOVE },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("CRUSH KIN"), 6, BALL_ULTRA },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("SIS AND BRO"), 1, BALL_DIVE },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("{PKMN} PROF."), 25, BALL_ULTRA },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("{PKMN} TRAINER"), 1, BALL_POKE },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("CRUSH GIRL"), 6, BALL_ULTRA },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("TUBER"), 1, BALL_DIVE },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { _("{PKMN} BREEDER"), 7, BALL_HEAL },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { _("{PKMN} RANGER"), 9, BALL_SAFARI },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("AROMA LADY"), 7, BALL_NEST },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("RUIN MANIAC"), 12, BALL_SAFARI },
    [TRAINER_CLASS_LADY_FRLG] =            { _("LADY"), 50, BALL_LUXURY },
    [TRAINER_CLASS_PAINTER_FRLG] =         { _("PAINTER"), 4, BALL_PREMIER },
};
