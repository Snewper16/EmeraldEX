...
static const struct {
...
} sPokeOutbreakSpeciesList[] = {
    {
        ...
        .moves = {MOVE_GROWL, MOVE_SHADOW_SNEAK, MOVE_FAKE_TEARS},
        .level = 5,
        .location = MAP_NUM(MAP_ROUTE102)
    },
    {
        .species = SPECIES_GIBLE,
        .moves = {MOVE_BITE, MOVE_DRAGON_RAGE, MOVE_GROWL, MOVE_ICE_FANG},
        .level = 15,
        .location = MAP_NUM(MAP_ROUTE113),
    },
    {
        .species = SPECIES_ZORUA,
        .moves = {MOVE_GROWL, MOVE_SNARL, MOVE_HOWL, MOVE_BITE},
        .level = 13,
        .location = MAP_NUM(MAP_ROUTE117),
    },
    {
        .species = SPECIES_CRAMORANT,
        .moves = {MOVE_DIVE, MOVE_FLY, MOVE_FEATHER_DANCE, MOVE_BELCH},
        .level = 25,
        .location = MAP_NUM(MAP_ROUTE120),
    },
    {
        .species = SPECIES_CHARCADET,
        .moves = {MOVE_WILL_O_WISP, MOVE_FLAME_BURST, MOVE_LEER, MOVE_ASTONISH},
        .level = 8,
