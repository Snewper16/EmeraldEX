...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[] = {
    ...
    {FACILITY_CLASS_GYM_LEADER_BRAWLY,          TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_MAGMA_BOSS_MAXIE,     TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {FACILITY_CLASS_MAGMA_GRUNT_F,          TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {FACILITY_CLASS_GYM_LEADER_ROXANNE,         TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_BURGLAR_FRLG,                TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_SCHOOL_KID_M,           TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_GYM_LEADER_TATE_AND_LIZA,   TRAINER_ENCOUNTER_MUSIC_TWINS},
