...
{
    {RS_FACILITY_CLASS_AQUA_BOSS_ARCHIE, FACILITY_CLASS_AQUA_BOSS_ARCHIE},
    ...
    {RS_FACILITY_CLASS_GYM_LEADER_F, FACILITY_CLASS_GYM_LEADER_ROXANNE},
    {RS_FACILITY_CLASS_GYM_LEADER_M, FACILITY_CLASS_GYM_LEADER_BRAWLY},
    {RS_FACILITY_CLASS_GYM_LEADER_MF, FACILITY_CLASS_GYM_LEADER_TATE_AND_LIZA},
    ...
    {RS_FACILITY_CLASS_MAGMA_BOSS, FACILITY_CLASS_MAGMA_BOSS_MAXIE},
