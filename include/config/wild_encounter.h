...
// Wild Battle Flags
#define WE_FLAG_FORCE_DOUBLE_WILD    FLAG_DOUBLE_WILDS     // If this flag is set, all land and surfing wild battles will be double battles.
...
#define WE_FLAG_NO_CATCHING           FLAG_DISABLE_CATCH     // If this flag is set, the ability to catch wild Pokémon is disabled.
