...
#define ITEM_FRIENDSHIP_MAPSEC_BONUS  50  // The amount of bonus friendship gained when an item is used on a Pokémon whose met location matches the current map section.
#define ITEM_FRIENDSHIP_LUXURY_BONUS  100 // The amount of bonus friendship gained when a Pokémon is in the Luxury Ball.
...
#define X_ITEM_FRIENDSHIP_INCREASE    10   // The amount of friendship gained by using an X item on a Pokémon in battle.
